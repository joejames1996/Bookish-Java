...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Jdbi jdbi = Jdbi.create("jdbc:mysql://10.210.11.106:3306/bookish?user=bookish&password=4q1WIfvybxBN&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT&ssl=true");
